...
public class CircularProgressBar extends ProgressBar {
  ...
  public CircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (isInEditMode()) {
      setIndeterminateDrawable(new fr.castorflex.android.circularprogressbar.CircularProgressDrawable.Builder(context).build());
      return;
    }
    ...
    fr.castorflex.android.circularprogressbar.CircularProgressDrawable.Builder builder = new fr.castorflex.android.circularprogressbar.CircularProgressDrawable.Builder(context)
  ...
  private fr.castorflex.android.circularprogressbar.CircularProgressDrawable checkIndeterminateDrawable() {
     ...
     if (ret == null || !(ret instanceof fr.castorflex.android.circularprogressbar.CircularProgressDrawable))
  ...
  public void progressiveStop(fr.castorflex.android.circularprogressbar.CircularProgressDrawable.OnEndListener listener) {
